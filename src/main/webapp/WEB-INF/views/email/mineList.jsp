            ...
            <div class="pagination-wrapper">
                <ul class="pagination">
                    <li class="page-item \${pager.pre==false?'disabled':''}" value="${pageVO.pre}" id="pre">
                        <a class="page-link" href="/email/mine?page=${pageVO.page-1}" aria-label="Previous">
                    ...
                    <c:forEach var="i" begin="${pageVO.startNum}" end="${pageVO.lastNum}">
                        <li class="page-item ${pageVO.page==i? 'active':''}">
                            <a class="page-link page-num" href="/email/mine?page=${i}">${i}</a>
                        </li>
                    </c:forEach>

                    <li class="${pageVO.next?'':'disabled'}" id="next">
                        <a href="/email/mine?page=${pageVO.page+1}" aria-label="Next">
