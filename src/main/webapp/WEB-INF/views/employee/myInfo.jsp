...
<sec:authorize access="isAuthenticated()">
    ...
    <div class="content-container">
        ...
        <div class="profile-wrap card-df">
            <div class="profile-header">
                <img src="/resources/images/Icon3d/change.png"/>
                <div>
                    <h2 class="main-title">프로필 변경</h2>
                    <p class="main-desc">프로필 사진을 변경합니다.</p>
                </div>
            </div>
        ...
        <div class="sign-wrap card-df">
            <div class="header">
                <h2 class="main-title">서명 변경</h2>
                <p class="main-desc">전자결재에 필요한 서명을 설정합니다.</p>
            </div>
            <form id="signForm" method="POST" enctype="multipart/form-data">
                ...
                <label for="emplSignFile">
                    <img id="userSignProfile"
                         ...
                         alt="signImage"/>등록 </label>
                <input type="file" name="signPhotoFile" id="emplSignFile" hidden="hidden"/>
            </form>
        </div>


        <div class="alert-wrap card-df">
            <div class="header">
                <h2 class="main-title">알림 설정</h2>
                <p class="main-desc">알림 범위를 설정합니다.</p>
            </div>
            <form action="#">
                <div>
                    <p>업무 요청</p>
